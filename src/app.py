...
# ---------------- Load Models ----------------
log_model_path = r"D:\Stock_Market_Analysis\models\logistic_model.pkl"
lin_model_path = r"D:\Stock_Market_Analysis\models\linear_model.pkl"
...
st.dataframe(recent_data[['symbol', 'close', 'MA5', 'MA10', 'Volatility', 'RSI', 'pct_change']])
